...
@section('title','اضافة قطع غيار جديد')
...
@section('content')
    <div class="container mx-auto px-4 py-6" dir="rtl">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    إضافة فاتورة وتفاصيل قطع الغيار الخاصة بها
                </p>
            </div>
        ...
        <form action="{{ route('invoice.store', $maintenance) }}" method="POST" id="invoiceForm">
            @csrf
                ...
                <div class="grid grid-cols-1 gap-5 p-6 lg:grid-cols-3">
                    <div>
                        ...
                        <input id="invoice_number" name="invoice_number" type="text"
                            ...
                            readonly placeholder="مثال: INV-00001"
                    ...
                    <div>
                        ...
                        <input id="supplier" name="supplier" type="text" value="{{ old('supplier') }}"
                    ...
                    <table class="w-full text-right text-sm">
                        ...
                        <tbody id="invoiceDetails">
                            <tr class="invoice-row border-b border-border">
                                ...
                                <td class="px-4 py-3">
                                    <input type="text" name="details[0][spare]" required placeholder="اسم قطعة الغيار"
                                ...
                                <td class="px-4 py-3">
                                    <input type="number" name="details[0][qty]" value="1" min="1"
                                        step="1" required
                                ...
                                <td class="px-4 py-3">
                                    <input type="number" name="details[0][price]" min="0" step="0.01" required
                                ...
                                <td class="px-4 py-3">
                                    <input type="text" value="0.00" readonly name="details[0][row_sub_total]"

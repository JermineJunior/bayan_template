        ...
        <div class="mb-6">
            ...
            <dl class="mt-4 grid gap-4 sm:grid-cols-4">
                ...
                <div class="rounded-xl border border-border bg-surface p-4 shadow-sm">
                    ...
                    <dd class="mt-1 text-xl font-semibold text-foreground">{{ number_format((float) $invoice->amount, 2) }}</dd>
                </div>
                <div class="rounded-xl border border-border bg-surface p-4 shadow-sm">
                    <dt class="text-xs text-muted-foreground">المدفوع</dt>
                    <dd class="mt-1 text-xl font-semibold text-foreground">{{ number_format($invoice->total_paid, 2) }}</dd>
                </div>
                <div class="rounded-xl border border-border bg-surface p-4 shadow-sm">
                    ...
                    <form
                        ...
                        x-data="{
                            ...
                            submit() {
                                ...
                                Swal.fire({
                                    title: 'تأكيد العملية',
                                    text: 'المبلغ المدخل أكبر من الرصيد المتبقي ({{ number_format($invoice->balance, 2) }}) — هل تريد المتابعة؟',
                                    icon: 'warning',
